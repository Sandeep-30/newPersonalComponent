/**
 * PenDistributionKernel defines the minimal kernel functionality
 * required to represent and manipulate a collection of shops, each
 * maintaining inventory counts for different pen types.
 *
...
public interface PenDistributionKernel extends Standard<PenDistribution> {
    ...
    /**
     * Adds (or restocks) a given quantity of a specific pen type
     * to a given shop.
     *
     * @param shop
     *     the shop identifier
     ...
     * @requires quantity > 0
     * @ensures
     *     this = #this with quantity added to (shop, pen)
     */
     ...
     * @requires
     *     quantity > 0 and
     *     stock(fromShop, pen) >= quantity
     * @ensures
     *     this = #this with quantity moved from fromShop to toShop
     */
     ...
     *     the pen SKU or model name
     * @return
     *     the number of pens currently available
     * @requires
     *     shop and pen are defined in this
     * @ensures
     *     this = #this
     */
     ...
     *
     * @return
     *     the number of shops represented in this
     * @ensures
     *     getShopCount = |shops|
     */
    int getShopCount();
