...
graph TD
    A["Standard<PenDistribution>"]
    B["PenDistributionKernel"]
    C["PenDistribution"]
    D["PenDistributionSecondary (abstract class)"]
    E["PenDistribution1L (kernel implementation)"]
...
- Designed kernel and enhanced interfaces for PenDistribution component
